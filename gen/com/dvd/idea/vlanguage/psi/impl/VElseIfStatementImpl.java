...
public class VElseIfStatementImpl extends ASTWrapperPsiElement implements VElseIfStatement {

  public VElseIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public VIfStatement getIfStatement() {
    return findNotNullChildByClass(VIfStatement.class);
  }
